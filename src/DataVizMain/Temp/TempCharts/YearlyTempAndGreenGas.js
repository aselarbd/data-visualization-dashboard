...
const YearlyTempAndGreenGas = () => {

    // ------------------------------------ Greenhouse gas vs Temp over years chart tweaks -----------------------------------

    // Data URL
    const GG_dataURL ='/data/ggTempComp.csv';
    ...
    const GreenGas_dataFilterTypesColors =[
        ...
        {name:"Temperature", type:"Temperature", color:"#005D6E"}
    ];
    ...
    //Title
    const GreenGas_ChartTitle ="Greenhouse gases vs Temperature Comparison over time";
...
export default YearlyTempAndGreenGas;
